...
namespace CareerCloud.BusinessLogicLayer
{
    public class SecurityLoginLogic : BaseLogic<SecurityLoginPoco>
    {
        ...
        //reference on RNGCryptoServiceProvider https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.rngcryptoserviceprovider?view=netcore-3.1
        ...
        private string ComputeHash(string plainText, byte[] saltBytes)
        {
            ...
            //SHA 512 https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.sha512managed?view=netcore-3.1
